  ...
  return (
    <div className="bg-white rounded-lg shadow-md p-4 hover:shadow-lg transition-shadow duration-300">
      ...
      {repository.description && (
        <div className="max-h-40 min-h-40 overflow-y-auto markdown-content mb-3 custom-scrollbar">
          <div className="text-sm text-gray-700 prose prose-sm bg-gray-100 p-1 rounded-sm m-t-1">
            <ReactMarkdown>
              {repository.description}
            </ReactMarkdown>
          </div>
